...
private:
    ...
    /**
     * @brief PID Offset output for eliminating
     * steady state disturbance effects.
     * Example: 
     * On Z axis, vehicle weighs slightly less
     * than the byouancy force, therefore a lift force
     * of approx 4N is present, to eliminate such 
     * force, on linear Z axis, 1 is added as output, 
     * which then will be generated by 4 Z thrusters 
     * to get 4N of total thrust.
     */
    double offset[6] = {0, 0, 1.0, 0, 0, 0};
